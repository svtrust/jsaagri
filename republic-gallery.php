				...
				<div class="card">
					...
					<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
						<div class="card-body">
							<div class="col-md-12">
								<div class="container">
  <div class="column col-sm-2 col-xs-4">
    <img src="images/img_nature.jpg" class="img-thumb img-achiev" onclick="openModal();currentSlide(1)" class="hover-shadow cursor">
  </div>
  <div class="column col-sm-2 col-xs-4">
    <img src="images/img_snow.jpg" class="img-thumb img-achiev" onclick="openModal();currentSlide(2)" class="hover-shadow cursor">
  </div>
  <div class="column col-sm-2 col-xs-4">
    <img src="images/img_mountains.jpg" class="img-thumb img-achiev" onclick="openModal();currentSlide(3)" class="hover-shadow cursor">
  </div>
  <div class="column col-sm-2 col-xs-4">
    <img src="images/img_lights.jpg" class="img-thumb img-achiev" onclick="openModal();currentSlide(4)" class="hover-shadow cursor">
  </div>
  <div class="column col-sm-2 col-xs-4">
    <img src="images/img_nature.jpg" class="img-thumb img-achiev" onclick="openModal();currentSlide(5)" class="hover-shadow cursor">
  </div>
  <div class="column col-sm-2 col-xs-4">
    <img src="images/img_snow.jpg" class="img-thumb img-achiev" onclick="openModal();currentSlide(6)" class="hover-shadow cursor">
  </div>
  <div class="column col-sm-2 col-xs-4">
    <img src="images/img_mountains.jpg" class="img-thumb img-achiev" onclick="openModal();currentSlide(7)" class="hover-shadow cursor">
  </div>
  <div class="column col-sm-2 col-xs-4">
    <img src="images/img_lights.jpg" class="img-thumb img-achiev" onclick="openModal();currentSlide(8)" class="hover-shadow cursor">
  </div>
