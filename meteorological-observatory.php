        ...
        <section id="about" style="margin-top:35px;">
            ...
            <div class="container">
             <div class="page-header space-left">
                    <h3>Meteorological Observatory</h3>
                </div>
              <div class="col-md-7">

                <p>JSACAT, Department of Agronomy, Agricultural Meteorology unit was established with an aim of students education and for giving weather forecast to the adjoining villages mainly for their agricultural benefits. Weather and climate are two basic resources which are considered as basic input for agricultural planning. Moreover, every plant process related with growth development and its yield is highly influenced by weather. Hence, scope behind agricultural meteorology remains distinct for agricultural success.</p> <!-- The instruments listed below are installed in our unit to enable better collection, processing of data and to forecast the weather in an explicit manner. -->
          ...
          <div class="col-md-5">
            <img src="images/meteorological-observatory-page.jpg" alt="" class="img-achiev" />
