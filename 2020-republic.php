...
<div class="preview col">
    <!-- <div class="api-controls">
        <button class="cfg-btn" onclick="MagicThumb.start('mgt-1')">Start</button>
        <button class="cfg-btn" onclick="MagicThumb.stop('mgt-1')">Stop</button>
        <button class="cfg-btn" onclick="MagicThumb.refresh('mgt-1')">Refresh</button>
        <button class="cfg-btn" onclick="MagicThumb.expand('mgt-1')" >Expand</button>
        <button class="cfg-btn" onclick="MagicThumb.restore('mgt-1')" >Restore</button>
        <button class="cfg-btn" onclick="MagicThumb.next('mgt-1')" >Next</button>
        <button class="cfg-btn" onclick="MagicThumb.prev('mgt-1')" >Prev</button>
    </div> -->
