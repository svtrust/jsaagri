...
var alldata =[];
    ...
    {
      console.log(staffs[e]);
      if(staffs[e].resume!='#')
      resumelink="<a href='staffdetails/"+staffs[e].resume+"' class='btn btn-primary resumelink' target='_blank'>Resume</a>";
      else
      resumelink="<a href='"+staffs[e].resume+"' class='btn btn-primary resumelink' >Resume</a>";
    ...
    if(tempdep!=staffs[e].depTeam)
    {
      ...
      var datalist = "<div class='col-sm-3'><div class='card'><div class='card-body'><div class='col-md-12 staff-image-div'><img src='images/"+staffs[e].photo+"' class='staff-image'></div><h7 class='card-title'>"+staffs[e].name+"</h7><p>"+staffs[e].position+" ("+staffs[e].dep+") </p>"+resumelink+"</br></div></div></div>";

      alldata[i]=datalist;

      i++;
      // if(tempdep == '<?php echo $_GET["dep"];?>')
        staffdetails += "<div class='col-sm-3'><div class='card'><div class='card-body'><div class='col-md-12 staff-image-div'><img src='images/"+staffs[e].photo+"' class='staff-image'></div><h7 class='card-title'>"+staffs[e].name+"</h7><p>"+staffs[e].position+" ("+staffs[e].dep+") </p>"+resumelink+"</br></div></div></div>";
